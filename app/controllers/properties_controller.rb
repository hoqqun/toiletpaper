class PropertiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @property.save
        format.html { redirect_to @property, notice: '物件情報の登録に成功しました。' }
  ...
  def update
    respond_to do |format|
      if @property.update(property_params)
        format.html { redirect_to @property, notice: '物件情報の更新に成功しました。' }
  ...
  def destroy
    @property.destroy
    respond_to do |format|
      format.html { redirect_to properties_url, notice: '物件情報の削除に成功しました。' }
